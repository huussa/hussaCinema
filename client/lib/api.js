...
export const api = {
  ...
  getShowtimes: (date) => request(`/showtimes?date=${encodeURIComponent(date)}`),
  ...
  register: (body) => request("/register", {
    method: "POST",
  ...
  requestLoginCode: (email) => request("/login/code", {
    method: "POST",
    body: JSON.stringify({ email })
  }),
  loginWithCode: (body) => request("/login/code/verify", {
    method: "POST",
    body: JSON.stringify(body)
  }),
  ...
  createMovie: (body) => request("/movies", {
    method: "POST",
    body: JSON.stringify(body)
  }),
  updateMovie: (id, body) => request(`/movies/${id}`, {
    method: "PATCH",
    body: JSON.stringify(body)
  }),
  deleteMovie: (id) => request(`/movies/${id}`, { method: "DELETE" }),

  createShowtime: (movieId, body) => request(`/movies/${movieId}/showtimes`, {
    method: "POST",
    body: JSON.stringify(body)
  }),
  updateShowtime: (id, body) => request(`/showtimes/${id}`, {
    method: "PATCH",
    body: JSON.stringify(body)
  }),
