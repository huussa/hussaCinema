...
export default function LoginPage() {
  ...
  return (
    <main className="flex min-h-screen w-full bg-ink">
      <div className="hidden w-[44%] border-r border-white/[.05] bg-[radial-gradient(circle_at_30%_30%,rgba(159,23,37,.22),transparent_45%),#0c0809] lg:flex lg:flex-col lg:justify-between lg:p-12">
        <Logo />
        <div>
          <p className="text-xs uppercase tracking-[.3em] text-red-500">
            Welcome back
          </p>
          <h1 className="mt-4 max-w-lg text-6xl font-black leading-none">
            Your next movie night is waiting.
          </h1>
      ...
      <div className="flex w-full items-center justify-center px-5 py-10 lg:w-[56%] lg:px-12">
        <div className="w-full max-w-md">
          ...
          <div className="mt-12 lg:mt-0">
            ...
            <h2 className="mt-7 text-3xl font-bold">Sign in</h2>
            ...
            <label className="block">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  type="email"
                  required
                  className="h-12 w-full rounded-xl border border-white/[.08] bg-white/[.025] pl-10 pr-3 text-sm outline-none focus:border-red-600/60"
            ...
            <label className="block">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="h-12 w-full rounded-xl border border-white/[.08] bg-white/[.025] pl-10 pr-12 text-sm outline-none focus:border-red-600/60"
                  placeholder="••••••••"
                />
                <button
                  type="button"
          ...
          <Link
            href="/auth/code"
            className="mt-4 block text-center text-sm text-red-400 hover:text-red-300"
          >
